...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the inFynd documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "inFynd: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret inFynd API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "inFynd Chat";
...
export const STORE_TITLE = "inFynd Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your inFynd API key.";
