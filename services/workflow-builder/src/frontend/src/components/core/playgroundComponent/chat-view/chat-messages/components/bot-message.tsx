          ...
          >
            <div className="flex w-full items-start gap-3">
              {(thinkingActive || displayTime > 0 || chatMessage !== "") && (
                <div
                  className="relative hidden h-6 w-6 mt-[-1px] flex-shrink-0 items-center justify-center overflow-hidden rounded bg-muted text-2xl @[45rem]/chat-panel:!flex border-0"
                  style={
                ...
                >
                  <div className="flex h-5 w-5 items-center justify-center">
                    <LangflowLogo className="h-4 w-4 text-foreground" />
                  </div>
                </div>
              )}
